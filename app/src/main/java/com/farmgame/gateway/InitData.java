...
public class InitData{
    ...
    private static String initLand(){
        ...
        String[] array = new String[]{
                ...
                "(8, 2000, 0, NULL, '-1', 0, 0)",
                "(9, 2000, 0, NULL, '-1', 0, 0)",
                "(10, 3000, 0, NULL, '-1', 0, 0)",
                "(11, 3000, 0, NULL, '-1', 0, 0)",
                "(12, 3000, 0, NULL, '-1', 0, 0)",
                "(13, 3000, 0, NULL, '-1', 0, 0)",
                "(14, 3000, 0, NULL, '-1', 0, 0)",
                "(15, 4000, 0, NULL, '-1', 0, 0)",
                "(16, 4000, 0, NULL, '-1', 0, 0)",
                "(17, 4000, 0, NULL, '-1', 0, 0)",
                "(18, 4000, 0, NULL, '-1', 0, 0)",
                "(19, 4000, 0, NULL, '-1', 0, 0)",
        };
